...
from restaurants.views import homepage,restIndex,addMenu,restAnalytics,addMenu,viewFeedback,viewOrders
...
urlpatterns = [
    ...
    path('Restaurants/menu/',addMenu, name ='addMenu'), #put userid
    path('Restaurants/analytics/<int:user_id>',restAnalytics, name='viewAnalytics'),
    path('Restaurants/view_feeback/',viewFeedback, name='view-feedback'), #put userid
    path('Restaurants/view_orders/',viewOrders, name='today-orders'), #put userid
